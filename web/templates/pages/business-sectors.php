...
<section class="sectors-hero" style="background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=1600') center/cover;">
    <div class="container">
        <h1><?= $pageTitle ?></h1>
