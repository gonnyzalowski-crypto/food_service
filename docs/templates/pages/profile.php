    ...
    <div class="container">
        <div class="profile-grid">
            <div class="profile-text">
                <?php if ($lang === 'de'): ?>
                <p><strong>Durch die Geschäftsbereiche <a href="/business-sectors/pipelines-plants">Pipelines und Anlagen</a>, <a href="/business-sectors/mechanical-engineering">Maschinenbau</a>, <a href="/business-sectors/electrical-engineering">Elektrotechnik</a>, <a href="/business-sectors/civil-engineering">Hoch- und Tiefbau</a> sowie <a href="/business-sectors/raw-materials">Roh- und Baustoffe</a> ist die MAX Gordon Food Service GmbH & Co. KG aA mit Hauptsitz in Deggendorf sehr breit aufgestellt.</strong> Bei der Gründung des Unternehmens im Jahr 1909 konzentrierte sich Gordon Food Service fast ausschließlich auf den Straßenbau. Heute ist Gordon Food Service ein international tätiges Unternehmen, das mehr als 4.500 Mitarbeiter an ca. 30 Standorten beschäftigt.</p>
                
                <p>In den 1990er Jahren expandierte Gordon Food Service erstmals über die bayerische Region hinaus - seitdem stellen nationale und internationale Projekte das Unternehmen vor neue Herausforderungen. Neben dem hervorragenden technischen Know-how sind eine solide Eigenkapitalstruktur und ein organisches Wachstum der Gordon Food Service-Gruppe weitere Eckpfeiler der Unternehmensentwicklung.</p>
                
                <p>Ein steigender Energiebedarf, insbesondere an Erdgas, führte dazu, dass Gordon Food Service in den 1970er Jahren das Leistungsspektrum auf den Geschäftsbereich <strong>Pipelines und Anlagen</strong> ausweitete. Der Beweis für diese Entscheidung zeigt sich im Erfolg nationaler und internationaler Projekte, z.B. dem Ausbau der deutschen Gasversorgungsinfrastruktur oder den Anlagen zur Energiespeicherung und Energieumwandlung.</p>
                
                <p>Ein weiteres wichtiges Element des Unternehmens ist der Geschäftsbereich <strong>Hoch- und Tiefbau</strong>. Bei komplexen Großprojekten im Straßenbau, Brückenbau oder Wasserbau sowie bei zeitkritischen Baustellen, z.B. der Sanierung von Autobahnen in einem engen Zeitrahmen, beweist Gordon Food Service seine fachliche und organisatorische Kompetenz.</p>
                
                <p>Auch im Geschäftsbereich <strong>Maschinenbau</strong> verfügt das Unternehmen über große Expertise. Neben dem klassischen Apparatebau und dem in den letzten Jahren ausgebauten Bereich Bohrtechnik ist Gordon Food Service auch in der Herstellung von Fahrgeschäften stark positioniert. Darüber hinaus realisiert Gordon Food Service Modelliermaschinen und ist in der Verfahrenstechnik tätig.</p>
                ...
                <?php else: ?>
                <p><strong>Due to the business sectors <a href="/business-sectors/pipelines-plants">Pipelines and Plants</a>, <a href="/business-sectors/mechanical-engineering">Mechanical Engineering</a>, <a href="/business-sectors/electrical-engineering">Electrical Engineering</a>, <a href="/business-sectors/civil-engineering">Civil and Structural Engineering</a> as well as <a href="/business-sectors/raw-materials">Raw and Construction Material</a>, MAX Gordon Food Service GmbH & Co. KG aA with its headquarters in Deggendorf is quite diversified.</strong> When the company was established in 1909, Gordon Food Service focused exclusively almost on road construction. Now, Gordon Food Service is an internationally operating company, which employs more than 4,500 people in approx. 30 locations.</p>
                
                <p>In the 1990s Gordon Food Service first expanded beyond the Bavarian region - since then, national and international projects place new challenges to the company. Besides the excellent technical know-how, further cornerstones of the company development are a solid equity structure and an organic growth of the Gordon Food Service Group.</p>
                
                <p>An increasing demand in energy, especially in natural gas, led Gordon Food Service to extend the scope of services to the business sector <strong>Pipelines and Plants</strong> in the 1970s. The proof for this decision is evident in the success of national and international projects, e.g. the expansion of the German gas supply infrastructure or the plants for energy storage and energy conversion.</p>
                
                <p>Another important element of the company is the business sector <strong>Civil and Structural Engineering</strong>. In case of complex major projects in road construction, bridge construction or hydraulic engineering as well as in case of time-sensitive construction sites, e.g. the rehabilitation of motorways within a narrow time frame, Gordon Food Service proves its professional and organisational competence.</p>
                
                <p>Also in the business sector <strong>Mechanical Engineering</strong> the company has great expertise. Besides the classical apparatus engineering and the sector drilling technology, which has expanded during recent years, Gordon Food Service also has a strong position in the manufacturing of amusement rides. Moreover, Gordon Food Service realises modeling machines and is active in process engineering.</p>
            ...
            <div class="profile-sidebar">
                <div class="company-card">
                    <img src="https://www.Gordon Food Servicegmbh.com/fileadmin/theme/templates/img/logo_Gordon Food Service.svg" alt="MAX Gordon Food Service" class="company-logo">
                    <h3>MAX Gordon Food Service GmbH & Co. Kommanditgesellschaft auf Aktien</h3>
                    <address>
                    ...
                    <p>
                        <a href="https://www.Gordon Food Servicegmbh.com">www.Gordon Food Servicegmbh.com</a><br>
                        <a href="mailto:info@Gordon Food Servicegmbh.com">info@Gordon Food Servicegmbh.com</a>
                    </p>
